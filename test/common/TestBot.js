...
const script = require('../../src/statuspage');
...
class TestBotContext {
  ...
  shutdown() {
    ...
    delete process.env.HUBOT_STATUS_PAGE_SHOW_WORKING;
    delete process.env.HUBOT_STATUS_PAGE_TWITTER_ENABLED;
    nock.cleanAll();
    this.robot.shutdown();
  }
}
...
async function createTestBot(settings = {}) {
  ...
  process.env.HUBOT_STATUS_PAGE_ID = 'kctbh9vrtdwd';
  process.env.HUBOT_STATUS_PAGE_TOKEN = 'test_token';
  nock.cleanAll();
